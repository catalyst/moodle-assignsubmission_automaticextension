...
$string['settings:extensionlength_help'] = 'The extension period in hours that will be applied to the user when a request is made. Subsqent requests (if allowed) will increase the extension period by this ammount.';
