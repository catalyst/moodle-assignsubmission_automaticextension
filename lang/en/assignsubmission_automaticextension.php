...
$string['privacy:metadata:assignsubmission_automaticextension'] = 'List of requested automatic extensions';
$string['privacy:metadata:assignsubmission_automaticextension:assignid'] = 'The ID of an assignment an automatic extension was requested for';
$string['privacy:metadata:assignsubmission_automaticextension:courseid'] = 'The ID of a course an automatic extension was requested for';
$string['privacy:metadata:assignsubmission_automaticextension:timerequested'] = 'The time an automatic extension was requested';
$string['privacy:metadata:assignsubmission_automaticextension:userid'] = 'The ID of the user who requested an automatic extension';
...
$string['settings:coursemaximumrequests'] = 'Maximum requests per course';
$string['settings:coursemaximumrequests_help'] = 'The maximum number of requests a user can make for per course. Set to 0 to disable this limit and only enforce the per-assignment maximum';
...
$string['settings:maximumrequests_help'] = 'The maximum number of requests that a user can make for each assignment';
