...
class provider implements
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist as $context) {
            if ($context->contextlevel == CONTEXT_SYSTEM) {
                $list = [];
                $rows = $DB->get_records('assign_automaticextension', ['userid' => $userid]);
                foreach ($rows as $row) {
                    $list[] = [
                        'userid' => $userid,
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        global $DB;
        if ($context->contextlevel == CONTEXT_SYSTEM) {
            $DB->delete_records('assign_automaticextension', []);
        }
    }
    ...
    public static function delete_data_for_user(approved_contextlist $contextlist) {
        ...
        foreach ($contextlist as $context) {
            if ($context->contextlevel == CONTEXT_SYSTEM) {
                $DB->delete_records('assign_automaticextension', ['userid' => $userid]);
            }
        }
    }
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        if ($context->contextlevel == CONTEXT_SYSTEM) {
            $sql = "SELECT * FROM {assign_automaticextension}";
    ...
    public static function delete_data_for_users(approved_userlist $userlist) {
        ...
        if ($context->contextlevel == CONTEXT_SYSTEM) {
            ...
            foreach ($users as $user) {
                $DB->delete_records('assign_automaticextension', ['userid' => $user->id]);
            }
        }
    }
}
